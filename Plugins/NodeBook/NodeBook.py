...
from NodeBook.SetingWidget import SetingWidget
from NodeBook.pathjson.NodeIconPath import NodeIconPath
from NodeBook.QHoudiniEdit import QHoudiniEdit
from NodeBook.CodeActive import CodeAC
from NodeBook.NodeScrollArea import NodeScrollArea
...
class NodeWidget(QWidget):
    def __init__(self,parent,icon):
        ...
        icon2 = QIcon()
        icon2.addFile(__file__[:-11] + "image/xin.png", QSize(30,30), QIcon.Normal, QIcon.Off)
    ...
    def hoardingClickedEvent(self):
        """收藏点击按钮"""
        icon2 = QIcon()
        icon2.addFile(__file__[:-11] + "image/xin-1.png", QSize(30,30), QIcon.Normal, QIcon.Off)
        self.button3.setIcon(icon2)
    ...
    def initTextEdit(self):
        """初始化富文本"""
        path = PATH + '/data/'+SORT+"/"+ self.icon.icon_name + ".json"
...
class HoudiniHelp(QWidget):
    ...
    def initIniFlie(self):
        ...
        # 读取.ini文件
        conf.read(__file__[:-11]+"config.ini")
    ...
    def initWidget(self):
        ...
        self.line_edit.setAlignment(Qt.AlignLeft)#搜索栏文字左对齐
